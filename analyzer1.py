...
if __name__ == "__main__":
    ...
    analyzer = c.Analyzer("roottree_leptons.root")
    ...
    lep_mass_h = ROOT.TH1D("lep_mass_h", "Reconstructed Higgs mass (gen)", 50, 100, 150) # bins of 1 GeV
    lep_mu_pt = ROOT.TH1D("lep_mu_pt", "Muon pt (gen)", 50, 0, 500) # bins of 10 GeV
    lep_mu_eta = ROOT.TH1D("lep_mu_eta", "Eta distribution of muons (gen)", 100, -5, 5) # bins of .1 in eta
